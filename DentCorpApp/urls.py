...
from .views import ConsultoriosListView, PacientesListView, PacientesCreateView,EspecialidadesListView, ServiciosOdontologicosListView, PacientesListView, TurnosListView, TurnosCreateView, TurnosUpdateView
urlpatterns = [

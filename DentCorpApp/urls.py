...
from .views import ConsultoriosListView, PacientesListView, EspecialidadesListView, ServiciosOdontologicosListView, PacientesListView, TurnosDeleteView, TurnosListView, TurnosCreateView, TurnosUpdateView

# Generated by Django 4.2.7 on 2023-11-11 22:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_rol', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='DentCorpApp.roles')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_ciu', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='DentCorpApp.ciudades')),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_rol_usu', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='DentCorpApp.rolxusuario')),
                ('id_serv_odon', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='DentCorpApp.serviciosodontologicos')),
            ],
        ),
        migrations.AddField(
            model_name='rolxusuario',
            name='id_usu',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='DentCorpApp.usuarios'),
        ),
        migrations.CreateModel(
            name='PlanXCobertura',
            fields=[
        ...
        migrations.AddField(
            model_name='coberturasxusuario',
            name='id_rol_usu',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='DentCorpApp.rolxusuario'),
        ),
        migrations.AddField(
            model_name='ciudades',
            name='id_prov',

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_rol', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DentCorpApp.roles')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(related_name='DentCorpApp_users_groups', to='auth.group')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_ciu', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DentCorpApp.ciudades')),
            ],
        ),
        migrations.CreateModel(
            name='Turnos',
            fields=[
                ...
                ('id_asig_cons', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DentCorpApp.asignacionesconsultorio')),
                ('id_cob_usu', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DentCorpApp.coberturasxusuario')),
                ('id_rol_usu', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DentCorpApp.rolxusuario')),
                ('id_serv_odon', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DentCorpApp.serviciosodontologicos')),
            ],
        ),
        migrations.AddField(
            model_name='rolxusuario',
            name='id_usu',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DentCorpApp.usuarios'),
        ),
        migrations.CreateModel(
            name='PlanXCobertura',
            fields=[
                ...
                ('id_cob', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DentCorpApp.coberturas')),
                ('id_plan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DentCorpApp.planes')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_caja', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DentCorpApp.cajas')),
                ('id_serv_ext', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DentCorpApp.pagosservext')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_caja', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DentCorpApp.cajas')),
                ('id_turno', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DentCorpApp.turnos')),
            ],
        ),
        migrations.CreateModel(
            name='EspecXUsuario',
            fields=[
                ...
                ('id_espec', models.ForeignKey(max_length=5, on_delete=django.db.models.deletion.CASCADE, to='DentCorpApp.especialidades')),
                ('id_rol_usu', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DentCorpApp.rolxusuario')),
            ],
        ),
        migrations.AddField(
            ...
            name='id_plan_cob',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DentCorpApp.planxcobertura'),
        ),
        migrations.AddField(
            model_name='coberturasxusuario',
            name='id_rol_usu',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DentCorpApp.rolxusuario'),
        ),
        migrations.AddField(
            model_name='ciudades',
            name='id_prov',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DentCorpApp.provincias'),
        ),
        migrations.AddField(
            model_name='cajas',
            name='id_rol_usu',
        ...
        migrations.AddField(
            ...
            name='id_cons',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DentCorpApp.consultorios'),
        ),
        migrations.AddField(
            model_name='asignacionesconsultorio',
            name='id_espec_usu',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DentCorpApp.especxusuario'),
        ),
    ]

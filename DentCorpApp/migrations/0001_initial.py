    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='DentCorp\\static\\media\\img')),
                ...
                ('id_ciu', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='DentCorpApp.ciudades', verbose_name='Ciudad')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_asig_cons', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='DentCorpApp.asignacionesconsultorio', verbose_name='consultorio')),
                ('id_cob_usu', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='DentCorpApp.coberturasxusuario', verbose_name='cobertura')),
                ('id_rol_usu', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='turnos_usuarios', to='auth.group', verbose_name='rol')),
                ('id_serv_odon', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='DentCorpApp.serviciosodontologicos', verbose_name='servicio')),
                ('id_usu', models.ForeignKey(db_column='id_usu', on_delete=django.db.models.deletion.PROTECT, related_name='turnos_usuarios', to=settings.AUTH_USER_MODEL, verbose_name='paciente')),
            ],
            options={

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_asig_cons', models.ForeignKey(db_column='id_asig_cons', on_delete=django.db.models.deletion.PROTECT, to='DentCorpApp.asignacionesconsultorio')),
                ('id_cob_usu', models.ForeignKey(db_column='id_cob_usu', on_delete=django.db.models.deletion.PROTECT, to='DentCorpApp.coberturasxusuario')),
                ('id_rol_usu', models.ForeignKey(db_column='id_rol_usu', on_delete=django.db.models.deletion.PROTECT, related_name='turnos_usuarios', to='auth.group')),
                ('id_serv_odon', models.ForeignKey(db_column='id_serv_odon', on_delete=django.db.models.deletion.PROTECT, to='DentCorpApp.serviciosodontologicos')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_espec', models.ForeignKey(max_length=5, on_delete=django.db.models.deletion.PROTECT, to='DentCorpApp.especialidades')),
                ('id_rol_usu', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='especialidad_usuario', to='auth.group')),
        ...
        migrations.AddField(
            model_name='ciudades',
            name='id_prov',
            field=models.ForeignKey(db_column='id_prov', on_delete=django.db.models.deletion.DO_NOTHING, to='DentCorpApp.provincias'),
        ),
        migrations.AddField(
